...
public class UpdateCourseCommand implements Command {
    ...
    public ResponseContext execute(RequestContext requestContext) {
        ...
        if (btnUpdate != null) {
            ...
            List<CourseDto> notFinishedCourse;
            ...
            try {
                ...
                notFinishedCourse = getNotUserFinishedCourses(teacher);
    ...
    private boolean isThisTeacherMentor(UserDto teacher, CourseDto courseDto){
