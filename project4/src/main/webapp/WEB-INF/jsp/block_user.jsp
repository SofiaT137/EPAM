   ...
   <head>
    ...
    <c:choose>
      ...
      <div class="form-group">
             ...
             <input name="lblFirstName" type="text" placeholder="${FirstLabel}" required pattern="^[a-zA-Zа-яА-Я '.-]{2,20}$" />
           </div>
           <p></p>
               <div class="form-group">
             <label>${lastName}</label>
             <input name="lblLastName"type="text" placeholder="${LastLabel}" required pattern="^[a-zA-Zа-яА-Я '.-]{2,20}$" />
              </div>
           <p></p>
             <label>${Group}</label>
              <select name="Group">
