            ...
            <c:otherwise>
              ...
              <div class="paggination">
                <c:if test="${current_page != 1}">
                  <td>
                    <a href="/controller?command=SHOW_REVIEW_PAGE_COMMAND&page=${current_page - 1}">${previous}</a>
                  </td>
                </c:if>
                ...
                <%--For displaying Next link --%>
                  <c:if test="${current_page lt number_of_pages}">
                    <td>
                      <a href="/controller?command=SHOW_REVIEW_PAGE_COMMAND&page=${current_page + 1}">${next}</a>
                    </td>
                  </c:if>
              </div>
            </c:otherwise>
